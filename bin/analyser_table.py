...
def main() -> int:
    ...
    OUT.write_text(
        ...
        f"inventory publishes about itself. One is a target this corpus can present "
        f"(C, LLVM IR, binary, trace or x86); the other, availability as the inventory "
        ...
        f"document, cited in place: Binsec's variable-latency tick, from the release "
        f"adding dividend and divisor to \\texttt{{-checkct-features}}; the pinned "
