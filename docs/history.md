...
Counts in these entries were true when written and most have moved since. The README's status
section has the current ones, and the records under `results/` have the generated ones.

## Status, as this record stood when it moved out of the README
