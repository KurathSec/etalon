    ...
    169c:	45 38 c2             	cmp    %r8b,%r10b
    169f:	41 89 f2             	mov    %esi,%r10d
    16a2:	8b 4c 24 fc          	mov    -0x4(%rsp),%ecx
    16a6:	0f 92 c1             	setb   %cl
    16a9:	41 83 f2 01          	xor    $0x1,%r10d
    16ad:	44 21 d1             	and    %r10d,%ecx
    16b0:	44 8b 54 24 f8       	mov    -0x8(%rsp),%r10d
    16b5:	0f b6 c9             	movzbl %cl,%ecx
    16b8:	09 ce                	or     %ecx,%esi
    16ba:	44 01 d1             	add    %r10d,%ecx
    16bd:	89 4c 24 f8          	mov    %ecx,-0x8(%rsp)
    16c1:	83 ef 01             	sub    $0x1,%edi
    16c4:	75 8a                	jne    1650 <sample_pos+0x20>
    16c6:	89 44 24 fc          	mov    %eax,-0x4(%rsp)
    16ca:	41 89 11             	mov    %edx,(%r9)
    16cd:	89 4c 24 f8          	mov    %ecx,-0x8(%rsp)
    16d1:	8b 44 24 f8          	mov    -0x8(%rsp),%eax
    16d5:	b8 00 02 00 00       	mov    $0x200,%eax
    16da:	c3                   	ret