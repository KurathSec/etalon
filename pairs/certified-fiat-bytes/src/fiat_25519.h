/* Vendored from mit-plv/fiat-crypto, fiat-c/src/curve25519_64.c (Apache-2.0 OR
 * BSD-1-Clause OR MIT). Generated, machine-checked constant-time field arithmetic
 * for Curve25519. Used unmodified as a CERTIFIED constant-time negative: a finding
 * on this code by any analyser is a genuine false positive, not a site-local one.
 * All functions are static inline, so this file is included as a header. */
#ifndef FIAT_25519_H
#define FIAT_25519_H
