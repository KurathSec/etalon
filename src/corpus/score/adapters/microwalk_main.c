/* Microwalk trace-target wrapper.
 *
 * Implements the Microwalk framework wrapper protocol: the PinNotify* markers
 * the pintool hooks by name, and a stdin loop reading 't <id>' plus a testcase
 * path, or 'e 0' to exit. Derived verbatim from the Microwalk c-github template
 * (github.com/microwalk-project/Microwalk, MIT), which is compatible with this
